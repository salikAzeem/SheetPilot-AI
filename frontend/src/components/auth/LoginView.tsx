...
export const LoginView: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-canvas-soft text-ink flex flex-col justify-between items-center py-8 px-4 font-sans relative">
      <div className="mesh-gradient-bg" />

      {/* Spacer / Container to center card vertically but allow shrinking on small viewports */}
      ...
      <footer className="text-center text-[10px] text-mute font-mono py-2">
